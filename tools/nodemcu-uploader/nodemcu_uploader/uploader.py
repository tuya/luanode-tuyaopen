...
class Uploader(object):
    ...
    def prepare(self):
        ...
        chunked transfer
        """
        log.info('Preparing tuyaopen for transfer.')
    ...
    def download_file(self, filename):
        ...
        res = self.__exchange('fd=io.open("%s", "r")'%filename)
    ...
    def write_file(self, path, destination='', verify='none'):
        ...
        # create file
        self.__writeln("fd = io.open('%s', 'w')"%destination)
        self.__expect(">")
        ...
        with open(path, 'r') as file:
            ...
            for line in lines:
                # print(data)
                self.__writeln("fd:writeline('%s')"%(line.strip("\n")))
                self.__expect(">")

                # self.__writeln("fd:write('\\n')")
                # self.__expect(">")
                
        # print(data)
        self.__writeln("fd:close()")
        self.__expect(">")
        ...
        #     # print(data)
        #     self.__writeln("fd:write('%s')"%(data))
        #     self.__expect(">")
    ...
    def node_heap(self):
        ...
        log.info('Heap')
        res = self.__exchange('print(sys.heap())')
        log.info(res)
